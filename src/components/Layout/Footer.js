        ...
        <>
            <footer className='p-5 object-cover w-full bg-cover bg-center lg:p-12' style={{ backgroundImage: `url(${require("../../assets/images/footer2.jpg")})` }}>
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div data-aos='fade-left' className='flex justify-end'>
                            ...
                            <ul className="text-black ">
                                <li className="mb-4">
                                    <p className='cursor-pointer mb-1 font-semibold'>Cookies</p>
                                    <p className='cursor-pointer mb-1 font-semibold'>Datenschutz</p>
                                    <p className='cursor-pointer mb-1 font-semibold'>AGB</p>
                                    <p className='cursor-pointer mb-1 font-semibold'>Impressum</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-black sm:text-center ">©  <a className="hover:underline">Besi Storen</a>. All Rights Reserved.
                    </span>
