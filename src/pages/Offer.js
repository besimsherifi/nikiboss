        ...
        <form onSubmit={handleSubmit}>
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div data-aos='fade-left'>
              <label htmlFor="lastname" className="block text-sm font-medium leading-6 text-gray-900" >Vorname</label>
            ...
            <div data-aos='fade-right'>
              <label htmlFor="number" className="block text-sm font-medium leading-6 text-gray-900">Telefon</label>
          ...
          <div data-aos='fade-up'>
            <label htmlFor="message" className=" mb-2 text-sm font-medium text-black">Angebot</label>
          ...
          <button type="submit" onSubmit={handleChange} data-aos='fade-right' className="text-white bg-custom-orange hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center ">Senden</button>
        </form>
      </div>
    </>
  );
